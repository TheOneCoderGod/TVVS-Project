...
class ControllerTest {
     ...
     */
    private static class NoThrowController extends Controller<String> {
     ...
     */
    private static class ThrowingController extends Controller<String> {
    ...
    class StepMethodTests {
        ...
        void testStepNoThrowNormal() throws IOException {
        ...
        void testStepNoThrowNullAction() throws IOException {
            Controller<String> controller = new NoThrowController("Model");
        ...
        void testStepThrowingControllerNormalAction() throws IOException {
        ...
        void testStepThrowingControllerNullAction() {
            Controller<String> controller = new ThrowingController("Model");
    ...
    class StepMonstersTests {

        @Test
        @DisplayName("stepMonsters(...) with negative time => no exception by default")
        void testStepMonstersNegativeTime() throws IOException {
            Controller<String> controller = new NoThrowController("Model");
        ...
        void testStepMonstersZeroTime() throws IOException {
            Controller<String> controller = new NoThrowController("Model");
        ...
        void testStepMonstersPositiveTime() throws IOException {
            Controller<String> controller = new NoThrowController("Model");
        ...
        void testStepMonstersOverriddenPotentially() throws IOException {
